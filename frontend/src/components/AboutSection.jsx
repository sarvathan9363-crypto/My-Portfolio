          ...
          >
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mt-5">
                {["Full Stack", "REST APIs", "Deployment", "UI Systems"].map((tag) => (
                  <span
                    key={tag}
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              ...
              <a
                href={ResumePDF}
                download="Sarvathan_C_Resume.pdf"
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 group"
                style={{
                  background: "linear-gradient(135deg, rgba(185,28,28,0.12) 0%, rgba(185,28,28,0.06) 100%)",
                ...
                onMouseLeave={e => {
                  e.currentTarget.style.background = "linear-gradient(135deg, rgba(185,28,28,0.12) 0%, rgba(185,28,28,0.06) 100%)";
